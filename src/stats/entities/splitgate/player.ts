...
@Entity({ name: 'stats_splitgate_agg_player', database: DB_NAME })
class SplitgateAggregateStats extends BaseEntity {
...
@EntityRepository(SplitgateAggregateStats)
class SplitgateAggregateStatsRepository extends BaseRepository<SplitgateAggregateStats> {
    
}

export {
    SplitgateAggregateStats as Entity,
    SplitgateAggregateStatsRepository as Repository,
}